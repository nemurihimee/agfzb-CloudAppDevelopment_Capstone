...
def get_dealerships(request):
    context = {}
    if request.method == "GET":
        url = "https://6ce79f5f.eu-gb.apigw.appdomain.cloud/api/dealership/dealership"
...
def get_dealer_details(request,dealer_id):    
     ...
     if request.method == "GET":
        url = 'https://6ce79f5f.eu-gb.apigw.appdomain.cloud/api/review/get_reviews'
        # Get reviews from the URL
        reviews = get_dealer_reviews_from_cf(url, dealer_id)
        for review in reviews:
            context['review_list'].append(review)
        # Concat all dealer's short name
...
# ...
def add_review(request, dealer_id):
    print('add_review: ' + str(request))
    if request.method == "POST":
        url = 'https://6ce79f5f.eu-gb.apigw.appdomain.cloud/postreview/postreview'
        if request.user.is_authenticated:
            ...
            if request.POST.get('purchasecheck') != 'on':
                ...
                review['car_make'] = car[0].make.name
